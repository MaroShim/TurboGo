...
type Menu struct {
	Title    string
	HotKey   rune // Hotkey character (e.g. 'F')
	HotIndex int  // Index of the hotkey in Title
	Items    []MenuItem
}
...
type MenuBar struct {
	Menus        []Menu
	Active       bool // Whether menu navigation is currently focused
	OpenDropdown bool // Whether a dropdown is dropped down
	ActiveMenu   int  // Index of active menu
	ActiveItem   int  // Index of active item in dropdown
}
		...
		Menus: []Menu{
			...
			},
			{
				...
				Items: []MenuItem{
					...
					{IsSep: true},
					{Label: "Code complete", Shortcut: "Ctrl+Space", HotKey: 'M', HotIndex: 5, ActionID: "edit_complete"},
				},
			},
			{
				Title:    "Search",
				...
				Items: []MenuItem{
					...
					{Label: "Hover / Type info", Shortcut: "Alt+F1", HotKey: 'H', HotIndex: 0, ActionID: "search_hover"},
					{IsSep: true},
					{Label: "Search again", Shortcut: "Ctrl+L", HotKey: 'A', HotIndex: 7, ActionID: "search_again"},
					{Label: "Replace...", HotKey: 'R', HotIndex: 0, ActionID: "search_replace"},
			...
			},
			{
				...
				Items: []MenuItem{
					...
					{Label: "Tab Size: 4", HotKey: 'T', HotIndex: 0, ActionID: "options_tab_size"},
					{IsSep: true},
					{Label: "LSP Status...", HotKey: 'P', HotIndex: 2, ActionID: "options_lsp_status"},
				},
			},
			{
				Title:    "Window",
			...
			},
			{
				...
				HotIndex: 0,
				Items: []MenuItem{
					{Label: "Help Index", Shortcut: "Shift+F1", HotKey: 'H', HotIndex: 0, ActionID: "help_index"},
					{Label: "About Turbo Go...", HotKey: 'A', HotIndex: 0, ActionID: "help_about"},
				},
			},
		},
		Active:       false,
...
func (m *MenuBar) drawDropdown(screen tcell.Screen, startX int) {
	...
	ddWidth := contentWidth + 2 // single border
